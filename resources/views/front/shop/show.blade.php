            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                            ...
                            <div class="product-details">
                                ...
                                <div class="pd-color">
                                    ...
                                    <div class="pd-color-choose">
                                        @foreach (array_unique(array_column($product->productDetails->toArray(), 'color')) as $item)
                                            <div class="cc-item">
                                                <input type="radio" id="cc-{{ $item }}">
                                                <label for="cc-{{ $item }}"
                                                    class="cc-{{ $item }}"></label>
                                            </div>
                                        @endforeach
                                ...
                                <div class="pd-size-choose">
                                    @foreach (array_unique(array_column($product->productDetails->toArray(), 'size')) as $item)
                                        <div class="sc-item">
                                            <input type="radio" id="sm-{{ $item }}">
                                            <label for="sm-{{ $item }}">{{ $item }}</label>
                                        </div>
                                    @endforeach
                                </div>
                                <div class="quantity">
                                    <form action="{{ route('addToCart.create', $product->id) }}" method="post">
                                        @csrf
                                        <div class="quantity">
                                            <div class="pro-qty">
                    ...
                    <div class="product-tab">
                        <div class="tab-item d-flex justify-content-center">
                                            ...
                                            @foreach ($product->productComments as $item)
                                                <div class="co-item">
                                                    <div class="avatar-pic">
                                                        <img src="front/img/product-single/{{ $item->user->avatar ?? 'default-avatar.jpg' }}"
                                                            alt="">
                                                    </div>
                                        ...
                                        <div class="leave-comment">
                                            ...
                                            <form action="" method="post" class="comment-form">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <textarea placeholder="Messages" name="messages" id="" cols="30" rows="10"></textarea>
